...
class PrmanageController extends Controller
{
    private $prmanage;
    private $user;

    public function __construct(DepartmentRepositoryInterface $prmanage, UserRepositoryInterface $user)
    {
        $this->prmanage = $prmanage;
        $this->user = $user;
    }
    /**
